...
function buildMetadata(sample) {
  d3.json("https://static.bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json").then((data) => {
    console.log("Full Data in buildMetadata:", data);
    ...
    Object.entries(result).forEach(([key, value]) => {
      console.log(`Appending metadata - ${key.toUpperCase()}: ${value}`);
...
function buildCharts(sample) {
  d3.json("https://static.bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json").then((data) => {
    console.log("Full Data in buildCharts:", data);
    ...
    console.log("Filtered Sample Data for sample", sample, ":", sampleData);
...
function init() {
  d3.json("https://static.bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json").then((data) => {
    console.log("Full Data in init:", data);
